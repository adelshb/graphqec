...
def test_base_code_noise_integration():
    """
    Verify that building the memory circuit inserts the correct noise instructions.
    """
    ...
    assert "DEPOLARIZE1(0.01)" in text_diagram, "Expected single-qubit noise not found in circuit."

    # Check for two-qubit noise
    assert "DEPOLARIZE2(0.02)" in text_diagram, "Expected two-qubit noise not found in circuit."
